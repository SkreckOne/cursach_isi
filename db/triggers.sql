...
BEGIN
   ...
   INSERT INTO orders (customer_id, collector_id, description, price)
   VALUES (p_customer_id, p_collector_id, p_description, p_price)
...
BEGIN
   ...
   IF v_order.status != 'completed' THEN
       RAISE EXCEPTION 'Order cannot be paid. Its status is not "completed".';
   END IF;
